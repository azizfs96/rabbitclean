...
return [
    ...
    */
    ...
    'msegat_api_key' => (string) env('MSEGAT_API_KEY'),
    'msegat_user_sender' => (string) env('MSEGAT_USER_SENDER'),
    'msegat_base_url' => (string) env('MSEGAT_BASE_URL', 'https://www.msegat.com/gw'),
