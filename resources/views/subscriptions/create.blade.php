        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">{{ __('Create Subscription Plan') }}</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('subscription.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('validity') is-invalid @enderror" 
                                                   id="validity" name="validity" value="{{ old('validity', 1) }}" min="1" required>
                                            @error('validity')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('validity_type') is-invalid @enderror" 
                                                ...
                                                @foreach($validityTypes as $type)
                                                    <option value="{{ $type->value }}" {{ old('validity_type') == $type->value ? 'selected' : '' }}>
                                                        {{ ucfirst($type->value) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="color" class="form-control @error('color') is-invalid @enderror" 
                                           id="color" name="color" value="{{ old('color', '#007bff') }}" style="height: 40px;">
                                    @error('color')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="laundry_credits" name="laundry_credits" 
                                           value="{{ old('laundry_credits', 0) }}" min="0">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="clothing_credits" name="clothing_credits" 
                                           value="{{ old('clothing_credits', 0) }}" min="0">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="delivery_credits" name="delivery_credits" 
                                           value="{{ old('delivery_credits', 0) }}" min="0">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="towel_credits" name="towel_credits" 
                                           value="{{ old('towel_credits', 0) }}" min="0">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="special_credits" name="special_credits" 
                                           value="{{ old('special_credits', 0) }}" min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> {{ __('Create Plan') }}
                            </button>
